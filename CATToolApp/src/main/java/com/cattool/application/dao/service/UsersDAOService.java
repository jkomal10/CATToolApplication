...
public class UsersDAOService {
	...
	public void saveUser(Users users,String createdBy) {
	...
	private void setNewPassword(String newPassword,Users user) {
		user.setPassword(newPassword);
		saveUser(user);
	}
	
	public void setUpdatedUser(Users user,String modifiedBy) {
