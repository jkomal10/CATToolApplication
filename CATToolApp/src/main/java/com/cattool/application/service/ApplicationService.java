...
public class ApplicationService {
	...
	public void cloudProviderCheck(int applicationId) {
		...
		for (CloudProvider cloudProvider : cloudProviderRepository.findByClientId(application.getClientId())) {
			...
			for (CloudProviderRule getCloudProviderRules : cloudProviderRuleRepository
					.findByCloudProviderId(cloudProvider.getCloudProviderId())) {
	...
	public List<Application> getAllFinalizeAplication(int clientId) {
		List<Application> applicationList = new ArrayList<>();
		applicationList = applicationRepository.findByClientIdAndIsDeletedAndIsFinalize(clientId, isDelete,
				isFinalizeValue);
		return applicationList;
	}
