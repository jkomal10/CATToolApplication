...
var AddApplicationComponent = /** @class */ (function () {
    function AddApplicationComponent(router, addapplicationService) {
        this.router = router;
    ...
    AddApplicationComponent = __decorate([
        ...
        __metadata("design:paramtypes", [router_1.Router, add_application_service_1.AddApplicationService])
